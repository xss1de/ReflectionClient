package xside.reflection.gui.clickgui.component.components.sub;
...
import xside.reflection.utils.GLUtils;
...
public class Checkbox extends Component {
	...
	public void renderComponent() {
		...
		{
			Gui.drawRect(parent.parent.getX() + 4 + 4, parent.parent.getY() + offset + 4, parent.parent.getX() + 8 + 4, parent.parent.getY() + offset + 8, Color.MAGENTA.getRGB());
		}else {
			Gui.drawRect(parent.parent.getX() + 5 + 4, parent.parent.getY() + offset + 5, parent.parent.getX() + 7 + 4, parent.parent.getY() + offset + 7, Color.MAGENTA.getRGB());
		}
	}
